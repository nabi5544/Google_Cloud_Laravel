...
<title>Triple Crown Bingo|Jones Road</title>
...
<!-- interior-design -->
<link rel="stylesheet" type="text/css" href="home/demo-categories/interior-design/css/interior-design.css" />
<!-- barber -->
<!--<link rel="stylesheet" type="text/css" href="home/demo-categories/barber/css/barber.css" />-->
<!-- Responsive -->
<link rel="stylesheet" type="text/css" href="home/css/responsive.css" />

<!-- Style customizer -->
<link rel="stylesheet" type="text/css" href="home/css/skins/skin-gold.css" data-style="styles"/>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBm0OuF5IThTJ10y7BKENC0RImDc00pgwE"></script>
    <script>
      function initMap() {
        ...
        var infowindow = new google.maps.InfoWindow({
          content: '<div class="map-pop"><p class="top">Triple Crown Bingo<br> (JONES ROAD)</p><span  onclick="calcRoute()"><i class="fas fa-directions" style="font-size: large;cursor: pointer; color:#d1bc58;"></i></span><p class="bottom-pop"><i class="fa-sharp fa-solid fa-location-dot" style="color: #d1bc58;"></i> Jones Road: 10535 Jones Road #200,<br> Houston 77065</p></div>'
        });
  ...
  var end = "Jones Road: 10535 Jones Road #200, Houston 77065"; // Set the destination to the location of the marker
  var request = {
    origin: start,
    destination: end,
...
<!--=================================
 ...
 <div class="headerMobile">
     <div class="row">
         <div class="col-10">
             <a href="/JONES_ROAD"><img  style="width:200px;" src="home/revolution/assets/slider-01/logog.png" alt=""> </a>
         </div>
         <div class="col-2">
  ...
  <div class="mobile-menu mobile-menu-hidden">
   ...
   <a href="/JONES_ROAD" style="text-align:left;padding-top:60px;"><img class="img-fluid" src="home/revolution/assets/slider-01/TCB LOGO-GOLD.png" style="height:70px;" alt=""> </a>
    </div>
   <a href="JONES_ROAD#play" @if($val1 == "ROAD") class="mobileactive" @endif ><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">  PRICING & PLAY TIMES </a> 
           
           <a href="/JONES_FOOD" @if($val1 == "FOOD") class="mobileactive" @endif><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">    FOOD</a> 
           
           <a href="/JONES_EVENTS"  @if($val1 == "EVENTS") class="mobileactive" @endif><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">    EVENTS</a> 
           
            <a href="/JONES_CORPORATE" @if($val1 == "CORPORATE") class="mobileactive" @endif><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">    CORPORATE EVENTS </a> 
            
            <a href="/JONES_INNER" @if($val1 == "INNER") class="mobileactive" @endif><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">    IN THE NEWS </a>
            
           <a href="JONES_ROAD#contact_us"><img  style="width:40px;" src="home/revolution/assets/slider-01/url_icon.png" alt="">    Contact us</a> 
    ...
    <p class="mobiledes"><strong>Triple Crown Bingo</strong> is Houston’s Ultimate Bingo Experience! Three convenient locations, paying out over $5,000 CASH daily.</p>
     <div class="social-icons color-hover float-center" style="padding:0px 10px">
         <ul>
          <li class="social-facebook text-theme"><a href="https://www.facebook.com/triplecrownbingo"><i class="fa fa-facebook text-white"></i></a></li>
          <li class="social-instagram text-theme"><a href="https://www.instagram.com/triple_crown_bingo/?hl=en"><i class="fa fa-instagram text-white"></i></a></li>
          <li class="social-tiktok text-theme"><a href="https://www.tiktok.com/@triple_crown_bingo"><i class="fab fa-tiktok text-white"></i> </a></li>
          <li class="social-yelp text-theme"><a href="https://www.yelp.com/biz/triple-crown-bingo-houston"><i class="fa fa-yelp text-white social"></i> </a></li>
         </ul>
       </div>
  </div>
</div>
     ...
     <div class="col-lg-12 col-md-12 position-relative">
      <!--menu start -->
       <nav id="menu" class="mega-menu">
        ...
        <ul class="menu-logo">
            <li>
                <a href="/JONES_ROAD"><img src="home/revolution/assets/slider-01/logog.png" alt="logo"> </a>
            </li>
        </ul>
         <!--menu links -->
        <div class="menu-bar">
         <ul class="menu-links">
            <li @if($val1 == "ROAD") class="active" @endif><a href="/JONES_ROAD#play">PRICING & PLAY TIMES</a>  </li>
           
            <li  @if($val1 == "FOOD") class="active" @endif ><a href="/JONES_FOOD">FOOD</a> </li>
            <li @if($val1 == "EVENTS") class="active" @endif><a href="/JONES_EVENTS">EVENTS</a> </li>
            <!--<li><a href="/JONES_CORPORATE_EVENTS">CORPORATE EVENTS</a> </li>-->
            <!--<li><a href="/JONES_INNER">INNER NEWS</a> </li>-->
               ...
               <div class="grid-row">
                 <!--grid column 3-->
                  <div class="grid-col-12">
                   <ul>
                     <li @if($val1 == "INNER") class="active" @endif><a href="/JONES_INNER">IN THE NEWS </a></li>
                     <li @if($val1 == "CORPORATE") class="active" @endif><a href="/JONES_CORPORATE">CORPORATE EVENTS</a></li>
            ...
            <!--<li><a href="#contact_us"> Contact us </a> </li>-->
             <li><button class="btn btn-primary" onclick="window.location.href='tel:(281) 502-2535'">CLICK TO CALL : (281) 502-2535 </button></li>
        </ul>
...
<footer class="footer footer-one-page page-section-pt black-bg" id="contact_us">
 <div class="container">
   ...
   <div class="col-lg-4 col-md-4">
      <div class="contact-add mb-30">
       <div class="text-center">
           ...
           <p>Jones Road:
10535 Jones Road #200, Houston 77065</p>
          </div>
      </div>
   </div>
   <div class="col-lg-4 col-md-4">
   ...
   <div class="col-lg-4 col-md-4">
    ...
    <div class="col-lg-4 col-sm-6 ">
      ...
      <!--      <li><a href="/JONES_ROAD_FOOD">FOOD</a> </li>-->
      <!--      <li><a href="/JONES_ROAD_EVENTS">EVENTS</a> </li>-->
      <!--      <li><a href="/JONES_CORPORATE_EVENTS">CORPORATE EVENTS</a> </li>-->
      <!--      <li><a href="/JONES_INNER">IN THE NEWS</a> </li>-->
            <!--<li><a href="#contact_us"> Contact us </a> </li>-->
    ...
    <div class="col-lg-12 col-sm-12">
      <div class="footer-useful-link footer-hedding text-center">
        <a href="/JONES_CONDITIONS" class="p-20">Terms & Conditions</a> &nbsp &nbsp
            <a href="/JONES_POLICY" class="p-20">Privacy Policy</a>
        </ul>
      </div>
    </div>
   ...
   <div class="footer-widget mt-20">
    <div class="row">
      <div class="col-lg-6 col-md-6">
       <p class="mt-15"> &copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> All Rights Reserved </p>
      </div>
      <div class="col-lg-6 col-md-6">
        <div class="social-icons color-hover float-end">
         <ul>
          <li class="social-facebook"><a href="https://www.facebook.com/triplecrownbingo"><i class="fa fa-facebook"></i></a></li>
          <li class="social-instagram"><a href="https://www.instagram.com/triple_crown_bingo/?hl=en"><i class="fa fa-instagram"></i></a></li>
          <li class="social-tiktok"><a href="https://www.tiktok.com/@triple_crown_bingo"><i class="fab fa-tiktok" style="line-height: 1;"></i> </a></li>
          <li class="social-yelp"><a href="https://www.yelp.com/biz/triple-crown-bingo-houston"><i class="fa fa-yelp"></i> </a></li>
         </ul>
       </div>
      </div>
    </div>
